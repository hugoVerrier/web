...
burgerList.forEach((burger,index) =>{
    ...
    <div class="p-2 border-black border-2 bg-[#FF6D60] grid grid-cols-2">

            <div class="">
            <img class="h-full w-full " src="${burger.img}">

            </div>
            <div class="px-4 py-8">
                <h2 class="p-4 text-3xl underline py-8"> ${burger.nom} </h2>

                 <p class=" text-xl text-justify py-8" >${burger.description} </p>
                 <p class=" text-2xl" > ${burger.prix} € </p>
            </div>
